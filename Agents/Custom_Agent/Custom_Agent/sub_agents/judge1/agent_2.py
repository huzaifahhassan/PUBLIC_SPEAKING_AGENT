...
judge1 = LlmAgent(
    ...
    * **Call-to-Action:** Is the call-to-action clear, compelling, and appropriate for this audience?
    ...
    ---
    ### **Output Format:**
    You MUST provide your feedback as a list of dictionaries. The key of each dictionary in the list will be an integer starting from zero. For value of each dictionary, use the following format:
    ...
    * **Suggestion:** A clear and concrete recommendation for how to fix the issue to better resonate with the audience.
    ...
    ---
    ### **Final Instruction:**
    The last item in the list will be a single, one-sentence summary of the script's persuasive strengths and weaknesses in relation to its intended audience and goal. **DO NOT** rewrite the script yourself. Your only function is to provide strategic critique.
